...
<html>
	...
	<body>
		...
		<br>
		<br>
		<form class="form-basic" method="post" action="./JeloUpdateController?id=${jelo.id}">
            ...
            <div class="form-row">
                <label>
                    ...
                    <input type="text" name="naziv" value="${jelo.nazivJela}">
                </label>
            </div>
            ...
            <div class="form-row">
                <label>
                    <span>Opis jela</span>
                    <input type="text" name="opis" value="${jelo.opisJela}">
                </label>
            </div>

            <div class="form-row">
                <button type="submit">Izmeni jelo</button>
            </div>
